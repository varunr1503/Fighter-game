...
# #jump animation ***
# warrior_jump = pygame.image.load('assets/images/warrior/Sprites/Jump.png').convert_alpha()
 
#define number of steps for each animation
...
while running:
    ...
    if round_over == False:
        if fighter_1.alive == False:
            score[1] +=1 # player 2 gets a point
            round_over = True
            round_over_time = pygame.time.get_ticks()
        elif fighter_2.alive == False:
            score[0] +=1 # player 1 gets a point
            round_over = True
            round_over_time = pygame.time.get_ticks()
    else:
